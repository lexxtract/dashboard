...
import AddCallReducer from "./add_call_reducer";
export { AddCallReducer };

// Import and reexport all procedure arg types

// Import and reexport all table handle types
import LlmResultRow from "./llm_result_table";
export { LlmResultRow };

// Import and reexport all types
import AddCall from "./add_call_type";
export { AddCall };
import LlmResult from "./llm_result_type";
export { LlmResult };
...
const tablesSchema = __schema(
  __table({
    ...
    constraints: [
      { name: 'llm_result_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, LlmResultRow),
);
...
const reducersSchema = __reducers(
  __reducerSchema("add_call", AddCallReducer),
);
